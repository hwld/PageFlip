define(["require", "exports"], function (require, exports) {
    ...
    var Helper = /** @class */ (function () {
         ...
         * @param {Point} point2
         */
        Helper.GetDistanceBetweenTwoPoint = function (point1, point2) {
         ...
         */
        Helper.GetSegmentLength = function (segment) {
         ...
         * @param {Segment} line2
         */
        Helper.GetAngleBetweenTwoLine = function (line1, line2) {
         ...
         */
        Helper.PointInRect = function (rect, pos) {
            if (pos === null) {
                return null;
            }
            if (pos.x >= rect.left &&
         ...
         */
        Helper.GetRotatedPoint = function (transformedPoint, startPoint, angle) {
            return {
         ...
         */
        Helper.LimitPointToCircle = function (startPoint, radius, limitedPoint) {
            ...
            var x = Math.sqrt((Math.pow(radius, 2) * Math.pow(a - n, 2)) /
         ...
         */
        Helper.GetIntersectBetweenTwoSegment = function (rectBorder, one, two) {
         ...
         */
        Helper.GetIntersectBeetwenTwoLine = function (one, two) {
         ...
         * @returns {Point[]}
         */
        Helper.GetCordsFromTwoPoint = function (pointOne, pointTwo) {
